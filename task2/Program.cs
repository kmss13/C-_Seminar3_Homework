...
int ReadInt(string message) //функция возврата введеного значения
{
...
int y2 = ReadInt("Введите координату х второй точки: ");
int z2 = ReadInt("Введите координату х второй точки: ");
